...
const CRON_DELIVERY_MODES = ["none", "announce", "direct", "webhook"] as const;
...
DELIVERY (top-level):
  { "mode": "none|announce|direct|webhook", "channel": "<optional>", "to": "<optional>", "threadId": "<optional>", "bestEffort": <optional-bool> }
